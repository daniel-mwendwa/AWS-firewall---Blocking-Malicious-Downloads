...
![AWS](https://img.shields.io/badge/AWS-Network%20Firewall-orange?logo=amazon-aws&logoColor=white)
![Suricata](https://img.shields.io/badge/IDS-Suricata-red?logo=suricata&logoColor=white)
![Security](https://img.shields.io/badge/Security-Enhanced-brightgreen?logo=securityscorecard&logoColor=white)
...
1. **Initial Testing** – Attempted access to a test malicious site (confirmed reachable).  
